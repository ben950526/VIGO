...
export default function TermsPage() {
  return (
    <LegalDocument title="使用條款">
      ...
      <LegalSection title="9. 推廣折抵點" id="promo-credits">
        <p>
          本平台得提供「推廣折抵點」活動，包含但不限於：（1）分享專屬邀請連結或邀請碼，若新使用者完成接案者註冊，邀請人得依公告獲得點數（例如每次 20 點）；（2）依公告於第三方社群平台公開宣傳本平台並附上邀請資訊，經本平台審核通過者，得依公告獲得點數（例如每次 100 點，且每人終身限領一次）。單一帳號折抵點累積上限以平台公告為準（例如 300 點）。
        </p>
        <p>
          折抵點<strong>不得兌換現金</strong>、不得轉讓予他人、亦不得用於平台外之任何用途。折抵點<strong>僅能於本平台正式推出付費訂閱方案後</strong>，依屆時公告之規則折抵訂閱費用；訂閱方案未上線前，折抵點僅供累積與查詢。
        </p>
        <p>
          本平台得因防弊、營運或法律需要，暫停、調整、收回折抵點或終止本活動，並得拒絕明顯異常、重複或違反本條款之邀請歸因或宣傳證明。活動細節以網站最新公告為準。
        </p>
      </LegalSection>

      <LegalSection title="10. 準據法與管轄">
